...
//CONSTANTS
import { CONTENT_SPACING, MAX_ZOOM_FACTOR, SAFE_AREA_PADDING } from '../../constants/camera';
//COMPONENTS
import { ButtonCapture } from './components/ButtonCapture';
import { StatusBarBlurBackground } from './components/StatusBarBlurBackground';
import { codeScannerQRPlugin } from './frameProcessors/codeScanner';
...
const CameraScreen = ({ navigation, route }) => {
  ...
  const frameProcessor = useFrameProcessor(codeScannerQRPlugin, []);
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Ionicons name={'caret-back-circle-outline'} color="gray" size={50} />
      </TouchableOpacity>
