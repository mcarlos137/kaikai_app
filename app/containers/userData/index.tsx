...
const UserDataScreen = ({ navigation, route, colors, userName, hmacInterceptor }) => {
  ...
  const SECTIONS = [
    ...
    },
    {
      type: 'shorts',
      title: 'Shorts',
      sectionContent: <Boby_SectionContent data={[]} />,
      canEdit: false,
      visible: true,
      buttons:
        [
          {
            ...
            title: 'List',
            onPress: () => {
              //navigateStore.dispatch({ type: NAVIGATE, payload: { target: 'ShortsScreen' } })
            }
          },
          {
            type: 'create',
            title: 'Create',
            onPress: () => {
              //navigateStore.dispatch({ type: NAVIGATE, payload: { target: 'ShortsCreateScreen' } })
            }
          }
        ]
    },
        ...
        [
          {
            ...
            title: 'List',
            onPress: () => {
              //broadcastingStore.getState().selectedTabState = 0
              //navigateStore.dispatch({ type: NAVIGATE, payload: { target: 'BroadcastingScreen' } })
            }
          },
          {
            type: 'create',
            title: 'Create',
            onPress: () => {
              //navigateStore.dispatch({ type: NAVIGATE, payload: { target: 'BroadcastingCreateScreen' } })
            }
          }
        ]
    },
        ...
        [
          {
            ...
            title: 'List',
            onPress: () => {
              //liveStreamingStore.getState().selectedTabState = 0
              //navigateStore.dispatch({ type: NAVIGATE, payload: { target: 'LiveStreamingScreen' } })
            }
          },
          {
            type: 'create',
            title: 'Create',
            onPress: () => {
              //navigateStore.dispatch({ type: NAVIGATE, payload: { target: 'LiveStreamingCreateScreen' } })
            }
          }
        ]
    },
