    ...
    <View style={{
      ...
      >
        ...
        >
          <Body_Picker
            selectedValue={pair}
            values={[{ label: 'BTCVES', value: 'BTCVES' }, { label: 'USDVES', value: 'USDVES' }, { label: 'BTCARS', value: 'BTCARS' }, { label: 'BTCCOP', value: 'BTCCOP' }, { label: 'EURUSD', value: 'EURUSD' }, { label: 'USDMXN', value: 'USDMXN' }, { label: 'USDCOP', value: 'USDCOP' }, { label: 'USDARS', value: 'USDARS' }]}
